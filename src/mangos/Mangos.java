...
public class Mangos {
    ...
    public static void main(String[] args) {
        ...
        19,25,24,17,21,6,6,14,33,30,7,32,20,4,14,9,32,28,36,0,26,36,15,26,27,17,35,5,17,19,23,29,23
        ,35,1,4,23,3,28,10,36,23,18,7,35,5,23,9,19,5,5,20,9,32,5,18,6,18,18,27,36,19,6,34,32,21,17,32
...
/*
        System.out.println("___________________________________________");
         ...
         Juego.ultimaNvecesRepe();*/


  //Juego.datosApuestaNoRepetir();
    
    
    //Juego.apuestaDosColumANoRepetirYCero(3);
